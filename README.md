...
We proved that DNNs are indeed capable of learning characteristics of multiple terrains at once and improving the performance of path finding algorithms. The code used in this paper can be found [here](https://github.com/Juliano-Pasa/Heuristic-NN-A-Star).
